  ...
  return (
    <div className="h-screen w-full bg-[#050711] text-gray-100 flex items-center justify-center p-3 sm:p-5 lg:p-8 relative overflow-hidden selection:bg-indigo-500 selection:text-white">
      ...
      <div className="w-full max-w-[1540px] mx-auto flex flex-col lg:flex-row justify-between items-center relative z-10 py-2 px-4 sm:px-8 lg:px-12 gap-8 lg:gap-12 max-h-[calc(100vh-2rem)]">
        ...
        {/* RIGHT COLUMN: Compact Height Login Card */}
        <div className="w-full lg:max-w-[490px] animate-fadeIn shrink-0 lg:mr-4 xl:mr-8">
          ...
          {/* Glass Card */}
          <div className="bg-[#0b101e]/90 backdrop-blur-2xl border border-gray-800/90 hover:border-indigo-500/40 rounded-3xl p-6 sm:p-7 shadow-[0_30px_90px_-20px_rgba(0,0,0,0.95),0_0_60px_-15px_rgba(99,102,241,0.25)] transition-all duration-300 space-y-4">
            {error && (
            ...
            {/* Registration Link */}
            <div className="pt-3.5 text-center text-xs text-gray-400 border-t border-gray-800/80">
          ...
          {/* Security Subtext */}
          <div className="mt-3.5 flex items-center justify-center space-x-2 text-[11px] text-gray-500">
