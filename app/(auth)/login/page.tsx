    ...
    <div className="h-screen w-full bg-[#050711] text-gray-100 flex items-center justify-center p-4 sm:p-6 relative overflow-hidden selection:bg-indigo-500 selection:text-white">
      ...
      <div className="w-full max-w-5xl mx-auto flex flex-col lg:flex-row items-center justify-center relative z-10 px-4 gap-10 lg:gap-16">
        ...
        <div className="hidden lg:block w-full max-w-[480px] space-y-4 text-left shrink-0">
          ...
          <div className="py-2.5 px-3.5 rounded-xl bg-[#0a0e1c]/90 border border-indigo-900/40 backdrop-blur-xl flex items-center justify-between gap-3 text-xs shadow-sm">
            <div className="flex items-center gap-2.5 min-w-0">
              <span className="h-2 w-2 rounded-full bg-emerald-400 animate-pulse shrink-0" />
              <span className="text-gray-300 truncate font-medium text-xs">
                Live Ingestion: Performance & speed themes updated
              </span>
            </div>
            <span className="text-[10px] font-bold text-indigo-300 bg-indigo-950/80 px-2 py-0.5 rounded border border-indigo-800/50 shrink-0 font-mono whitespace-nowrap">
              Syncing
            </span>
          </div>
        ...
        <div className="w-full max-w-[430px] shrink-0 animate-fadeIn">
          {/* Glass Card */}
          <div className="bg-[#0b101e]/90 backdrop-blur-2xl border border-gray-800/90 hover:border-indigo-500/40 rounded-2xl p-6 shadow-[0_20px_70px_-15px_rgba(0,0,0,0.9),0_0_40px_-10px_rgba(99,102,241,0.2)] transition-all duration-300 space-y-3.5">
            ...
            <div className="pt-2.5 border-t border-gray-800/80 space-y-1.5">
              ...
              <div className="grid grid-cols-3 gap-2">
                <button
                  ...
                  className="py-1.5 px-2 rounded-xl bg-indigo-950/60 hover:bg-indigo-900/80 border border-indigo-700/50 text-indigo-200 text-xs font-semibold text-center transition hover:border-indigo-400 cursor-pointer flex flex-col items-center justify-center shadow-sm"
                >
                  <span className="font-bold text-white">Admin</span>
                  <span className="text-[9px] text-indigo-300/80">Full Access</span>
                </button>
                ...
                <button
                  ...
                  className="py-1.5 px-2 rounded-xl bg-violet-950/60 hover:bg-violet-900/80 border border-violet-700/50 text-violet-200 text-xs font-semibold text-center transition hover:border-violet-400 cursor-pointer flex flex-col items-center justify-center shadow-sm"
                >
                  <span className="font-bold text-white">Analyst</span>
                  <span className="text-[9px] text-violet-300/80">Triage & AI</span>
                </button>
                ...
                <button
                  ...
                  className="py-1.5 px-2 rounded-xl bg-slate-900/80 hover:bg-slate-800 border border-gray-700 text-gray-200 text-xs font-semibold text-center transition hover:border-gray-500 cursor-pointer flex flex-col items-center justify-center shadow-sm"
                >
            ...
            {/* Registration Link */}
            <div className="pt-1.5 text-center text-xs text-gray-400">
          ...
          {/* Security Subtext */}
          <div className="mt-3 flex items-center justify-center space-x-2 text-[11px] text-gray-500">
