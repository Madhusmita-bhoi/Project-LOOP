        ...
        <div className="lg:col-span-7 space-y-6 text-left">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 pt-2">
            ...
            <div className="p-4 rounded-2xl bg-[#0b101e]/80 border border-gray-800/80 backdrop-blur-xl hover:border-indigo-500/30 transition-all duration-300 shadow-lg">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-[11px] font-bold text-emerald-400 bg-emerald-950/60 px-2 py-0.5 rounded-md border border-emerald-800/50">
                  +6.4%
                </span>
              </div>
            ...
            <div className="p-4 rounded-2xl bg-[#0b101e]/80 border border-gray-800/80 backdrop-blur-xl hover:border-indigo-500/30 transition-all duration-300 shadow-lg">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-[11px] font-bold text-indigo-300 bg-indigo-950/60 px-2 py-0.5 rounded-md border border-indigo-800/50">
                  42ms Latency
                </span>
              </div>
          ...
          <div className="flex flex-wrap items-center gap-4 text-xs text-gray-400 pt-1">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span>Role-Based Permissions (Admin, Analyst, Viewer)</span>
            </div>
          </div>
        </div>
