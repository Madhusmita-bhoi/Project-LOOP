...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen w-full bg-[#050711] text-gray-100 flex items-center justify-center p-4 sm:p-6 lg:p-10 relative overflow-hidden selection:bg-indigo-500 selection:text-white">
      ...
      <div className="absolute top-[10%] left-[10%] w-[700px] h-[700px] bg-gradient-to-tr from-indigo-600/20 via-violet-600/15 to-transparent rounded-full blur-[160px] pointer-events-none" />
      <div className="absolute bottom-[-10%] right-[10%] w-[600px] h-[600px] bg-blue-600/15 rounded-full blur-[150px] pointer-events-none" />

      {/* Harmoniously Sized 2-Column Split Container */}
      <div className="w-full max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-center relative z-10 py-6 px-4 sm:px-6">
        
        {/* LEFT COLUMN: Harmoniously Balanced Sizing */}
        <div className="space-y-4 text-left">
          ...
          {/* Clean Proportional Headline */}
          <div className="space-y-2">
            <h1 className="text-3xl sm:text-4xl lg:text-[40px] font-black tracking-tight leading-[1.15] text-white">
            ...
            <p className="text-sm text-gray-400 leading-relaxed">
              Unify tickets, reviews, and NPS surveys into real-time sentiment alerts, clustered themes, and grounded VoC executive digests.
            </p>
          </div>

          {/* Symmetrical Feature Cards */}
          <div className="grid grid-cols-2 gap-3.5 pt-1">
            {/* Card 1: Live CSAT */}
            <div className="py-3 px-4 rounded-2xl bg-[#0b101e]/80 border border-gray-800/80 backdrop-blur-xl hover:border-indigo-500/30 transition-all duration-300 shadow-md">
          ...
          {/* Live Ingestion Stream Pill */}
          <div className="py-2.5 px-4 rounded-xl bg-[#0a0e1c]/90 border border-indigo-900/40 backdrop-blur-xl flex items-center justify-between gap-3 text-xs">
            <div className="flex items-center gap-2 min-w-0">
              <span className="h-2 w-2 rounded-full bg-emerald-400 animate-pulse shrink-0" />
              <span className="text-gray-300 truncate font-medium text-[11px]">
                Live Stream: Performance & speed themes active across 162 items
              </span>
            </div>
