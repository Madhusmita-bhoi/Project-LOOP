  ...
  return (
    <div className="h-screen w-full bg-[#050711] text-gray-100 flex items-center justify-center p-3 sm:p-5 lg:p-8 relative overflow-hidden selection:bg-indigo-500 selection:text-white">
      ...
      <div className="w-full max-w-[1540px] mx-auto flex flex-col lg:flex-row justify-between items-center relative z-10 py-2 px-4 sm:px-8 lg:px-12 gap-8 lg:gap-12 max-h-[calc(100vh-2rem)]">
        ...
        {/* LEFT COLUMN: Pinned to the Left & Non-Scrollable Height */}
        <div className="w-full lg:max-w-[620px] space-y-3.5 text-left shrink-0">
          ...
          <div className="space-y-1.5">
            <h1 className="text-3xl sm:text-4xl lg:text-[40px] font-black tracking-tight leading-[1.12] text-white">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-0.5">
            <div className="p-3 sm:p-3.5 rounded-2xl bg-[#0b101e]/80 border border-gray-800/80 backdrop-blur-xl hover:border-indigo-500/30 transition-all duration-300 shadow-md">
        ...
        {/* RIGHT COLUMN: Compact Height Registration Card */}
        <div className="w-full lg:max-w-[490px] animate-fadeIn shrink-0 lg:mr-4 xl:mr-8">
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2 bg-[#070a14] border border-gray-800/90 rounded-xl text-xs sm:text-sm text-gray-100 placeholder-gray-500 focus:outline-none focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/20 transition shadow-inner font-medium"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    placeholder="••••••••••••"
                    className="w-full pl-10 pr-10 py-2 bg-[#070a14] border border-gray-800/90 rounded-xl text-xs sm:text-sm text-gray-100 placeholder-gray-500 focus:outline-none focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/20 transition shadow-inner font-medium"
                  />
                  <button
                    type="button"
